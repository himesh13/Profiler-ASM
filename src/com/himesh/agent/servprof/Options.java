...
//	private static final String OUTPUT_FILE_PATH_KEY = "f";
	...
	public static Options parse(String optionsStr) {
		...
		String outputFileFormat = readString(optionMap, OUTPUT_FILE_FORMAT_KEY, "");
		Utility.setOutputDirectory(outputFileFormat);
	...
	public String print() {
		return ("> Output file name: " + outputFileName 
				+ "\n> Class Pattern:    " + classPattern
				+ "\n> Method Pattern:   " + methodPattern + 
				"\n> Report interval:  " + reportIntervalMillis + " ms");
